...
const String sheet_url = "https://script.google.com/macros/s/AKfycbzLKvIvMW7VGMuFiQDO5XYSpFLZkU5dT-2YFbvzUZr0a6KuoLxH9In37VnzXLqf1bhY/exec?name=";  //Enter Google Script URL
...
//-----------------------------------------
#define WIFI_SSID "Galahad"  //Enter WiFi Name
#define WIFI_PASSWORD "whyarpit?"  //Enter WiFi Password
//-----------------------------------------

//Initialize the LCD display
LiquidCrystal_I2C lcd(0x3F, 8, 2);  //Change LCD Address to 0x27 if 0x3F doesnt work
